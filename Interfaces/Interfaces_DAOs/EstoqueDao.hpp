...
class EstoqueDao {
    ...
    public:
        ...
        EstoqueDao() {
            ...
            Item_Estoque* itensEstoque[10] = {
                new Item_Estoque(1, estoques[0], produtos[0], fornecedores[0]),
                new Item_Estoque(2, estoques[1], produtos[1], fornecedores[1]),
                new Item_Estoque(3, estoques[2], produtos[2], fornecedores[2]),
                new Item_Estoque(4, estoques[3], produtos[3], fornecedores[3]),
                new Item_Estoque(5, estoques[4], produtos[4], fornecedores[4]),
                new Item_Estoque(6, estoques[5], produtos[5], fornecedores[5]),
                new Item_Estoque(7, estoques[6], produtos[6], fornecedores[6]),
                new Item_Estoque(8, estoques[7], produtos[7], fornecedores[7]),
                new Item_Estoque(9, estoques[8], produtos[8], fornecedores[8]),
                new Item_Estoque(10, estoques[9], produtos[9], fornecedores[9])

            };
        }
    public:
       virtual void atualizar(int id_Pedido);
       virtual void subtairItensSolicitados(Item_Pedido* itens);
